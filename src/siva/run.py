...
from siva.evaluator.evaluator import EvaluationType, evaluate_simulation
from siva.metrics.agent_metrics import compute_metrics
from siva.orchestrator.orchestrator import Orchestrator
from siva.registry import RegistryInfo, registry
from siva.user.user_simulator import DummyUser, get_global_user_sim_guidelines
from siva.utils.display import ConsoleDisplay, Text
from siva.utils.pydantic_utils import get_pydantic_hash
from siva.utils.utils import DATA_DIR, get_commit_hash, get_now, show_dict_diff
...
def run_tasks(
    ...
    ConsoleDisplay.console.print(
        ...
        "To review the simulations, run: [bold blue]siva view[/bold blue]"
    )
    return simulation_results
